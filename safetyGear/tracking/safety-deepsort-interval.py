...
OUTPUT_VIDEO_PATH = "output_deepsort_test.mp4"
LOG_PATH = "deepsort_test_inference_log.txt"
...
CONF_THRESHOLD = 0.45
DETECTION_INTERVAL = 5   # YOLO 탐지 주기
LOG_INTERVAL = 30        # CPU/GPU 로그 기록 주기
...
while cap.isOpened():
    ...
    if frame_count % DETECTION_INTERVAL == 0:
        ...
        last_detections, last_cls_list = detections, cls_list
    else:
        # 이전 탐지 결과 사용
        detections, cls_list = last_detections, last_cls_list
    ...
    if frame_count % LOG_INTERVAL == 0:
        ...
        logging.info(f"Frame {frame_count} | FPS: {fps_now:.2f} | GPU: {gpu_mem:.2f} MB | CPU: {cpu_mem:.2f} MB")
