...
# 모델 불러오기
MODEL_PATH = "best3.pt"
SAVE_PATH = "best3_weight_pruned.pt"
...
# 프루닝 적용 (가중치 절댓값이 작은 순으로 제거)
total_layers = 0
for name, module in nn_model.named_modules():
    if isinstance(module, (nn.Conv2d, nn.Linear)):
        prune.l1_unstructured(module, name="weight", amount=SPARSITY)
        prune.remove(module, "weight")  # 마스크 제거 후 weight에 적용
        total_layers += 1

print(f"Conv/Linear 레이어 {total_layers}개에 {SPARSITY*100:.0f}% 가중치 기반 프루닝 적용 완료")
